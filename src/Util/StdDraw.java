...
/******************************************************************************
 *  Compilation:  javac Util.StdDraw.java
 *  Execution:    java Util.StdDraw
 *  Dependencies: none
 *
...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
   ...
   // private static ClientEngine clientEngine = null;
     ...
     * {@code Util.StdDraw.BLACK}, {@code Util.StdDraw.BLUE}, {@code Util.StdDraw.CYAN},
     * {@code Util.StdDraw.DARK_GRAY}, {@code Util.StdDraw.GRAY}, {@code Util.StdDraw.GREEN},
     * {@code Util.StdDraw.LIGHT_GRAY}, {@code Util.StdDraw.MAGENTA}, {@code Util.StdDraw.ORANGE},
     * {@code Util.StdDraw.PINK}, {@code Util.StdDraw.RED}, {@code Util.StdDraw.WHITE}, and
     * {@code Util.StdDraw.YELLOW}.
     *
...
/*
    private static BufferedImage getImage(String filename) {
        ...
        // in case file is inside a .jar (classpath relative to Util.StdDraw)
        try {
            URL url = Util.StdDraw.class.getResource(filename);
            BufferedImage image = ImageIO.read(url);
            return image;
        } 
        catch (IOException e) {
